 ...
 */
export async function create({curve = 'P-256'} = {}) {
  ...
  const recoveryKeyPair = await EcdsaMultikey.generate({curve});
...
export async function createEvent(
  ...
  // set previousEventHash before signing so it is covered by the operation proof
