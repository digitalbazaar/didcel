/**
 * @file JSON Schema validation for DID documents and Cryptographic Event Logs.
 */
...
const STATELESS_OPERATION = {
  type: 'object',
  required: ['type'],
  properties: {
    type: {type: 'string', enum: ['heartbeat', 'deactivate']}
  },
  additionalProperties: false
};
...
/**
 * Validates a DID document against the did:cel JSON Schema.
 *
 * @param {object} options - Options.
 * @param {object} options.didDocument - The DID document to validate.
 * @throws {Error} If the document is invalid, with details of all violations.
 */
...
/**
 * Validates a Cryptographic Event Log against the did:cel JSON Schema.
 *
 * @param {object} options - Options.
 * @param {object} options.cel - The CEL object to validate.
 * @throws {Error} If the CEL is invalid, with details of all violations.
 */
